...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_main_side_servo is
  ...
  signal \count_left0_carry__1_i_6_n_0\ : STD_LOGIC;
  signal \count_left0_carry__1_i_7_n_0\ : STD_LOGIC;
...
count_left0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => count_left0_carry_i_3_n_0,
      S(2) => count_left0_carry_i_4_n_0,
      S(1) => count_left0_carry_i_5_n_0,
      S(0) => count_left0_carry_i_6_n_0
    );
\count_left0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => '0',
      DI(0) => \count_left0_carry__0_i_3_n_0\,
      O(3 downto 0) => \NLW_count_left0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \count_left0_carry__0_i_4_n_0\,
      S(2) => \count_left0_carry__0_i_5_n_0\,
      S(1) => \count_left0_carry__0_i_6_n_0\,
      S(0) => \count_left0_carry__0_i_7_n_0\
    );
...
\count_left0_carry__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\count_left0_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\count_left0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \count_left0_carry__1_i_1_n_0\,
      DI(1) => \count_left0_carry__1_i_2_n_0\,
      DI(0) => \count_left0_carry__1_i_3_n_0\,
      O(3 downto 0) => \NLW_count_left0_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \count_left0_carry__1_i_4_n_0\,
      S(2) => \count_left0_carry__1_i_5_n_0\,
      S(1) => \count_left0_carry__1_i_6_n_0\,
      S(0) => \count_left0_carry__1_i_7_n_0\
    );
...
\count_left0_carry__1_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      ...
      O => \count_left0_carry__1_i_6_n_0\
    );
\count_left0_carry__1_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      ...
      O => \count_left0_carry__1_i_7_n_0\
    );
...
count_left0_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
