...
count_left0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => '0',
      DI(1) => count_left0_carry_i_2_n_0,
      DI(0) => '0',
...
\count_left0_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
count_left0_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
count_left0_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
