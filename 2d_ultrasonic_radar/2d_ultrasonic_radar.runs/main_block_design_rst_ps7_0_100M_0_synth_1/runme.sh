...
HD_PWD='/home/saba/Documents/workstation6/2d_ultrasonic_radar/2d_ultrasonic_radar.runs/main_block_design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_block_design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_block_design_rst_ps7_0_100M_0.tcl
