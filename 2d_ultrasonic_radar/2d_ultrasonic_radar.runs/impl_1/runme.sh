...
HD_PWD='/home/saba/Documents/workstation6/2d_ultrasonic_radar/2d_ultrasonic_radar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_block_design_wrapper.tcl -notrace
