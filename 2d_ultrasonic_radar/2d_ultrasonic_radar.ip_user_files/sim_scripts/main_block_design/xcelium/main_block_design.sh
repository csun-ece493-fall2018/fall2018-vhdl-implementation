...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.main_block_design \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"../../../../2d_ultrasonic_radar.srcs/sources_1/bd/main_block_design/ipshared/ec67/hdl" \
       +incdir+"../../../../2d_ultrasonic_radar.srcs/sources_1/bd/main_block_design/ipshared/5bb9/hdl/verilog" \
       +incdir+"../../../../2d_ultrasonic_radar.srcs/sources_1/bd/main_block_design/ipshared/70fd/hdl" \
